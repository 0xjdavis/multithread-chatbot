...
if not openai_api_key:
    ...
    # Calendly
    st.sidebar.markdown('<div style="border-radius:25%;background:#fff";width:100%;"><br/><br/><br/><center><span style="height:12px;width:12px;background-color:#77e0b5;border-radius:50%;display:inline-block;"></span> <b>Available for new projects!</b><br /><a href="https://calendly.com/0xjavis" target="_blank"><button style="background:#126ff3;color:#fff;border: 1px #126ff3 solid;border-radius:3px;">Schedule a call</button></a></center><br/><br/><br/></div>', unsafe_allow_html=True)
